...
public class UserServiceImpl implements UserService {
	 ...
	 * @param cmd
	 */
//	@EventAuditor(bizScenario = "'demo.users.getUserById'", operator = "${symbol_pound}operator",
//		content = "'用户' + ${symbol_pound}cmd.login + '修改了邮箱，从' + ${symbol_pound}queryOldEmail(${symbol_pound}cmd.id) + '修改为' + ${symbol_pound}cmd.email")
	@Transactional(rollbackFor = Exception.class)
	@Override
